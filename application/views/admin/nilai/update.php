<div class="container-fluid">
    ...
    <?php
    $rowSiswa = $this->db->select('*')->from('siswa')->where('id_siswa', $nilai->siswa_id)->get()->row();
    ?>
    ...
    <form action="" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="hidden" name="siswa_id" id="siswa_id" value="<?php echo $nilai->siswa_id ?>">
                <input type="text" class="form-control pencarian" name="detail_siswa" id="detail_siswa" placeholder="NIS - Nama Siswa" value="<?php echo $rowSiswa->nis . " - " . $rowSiswa->nama_siswa; ?>">
                <?php echo form_error('siswa_id', '<div class="text-danger small ml-3">', '</div>'); ?>
            </div>
            <div class="form-group col-md-6">
                <label for="nilai_tugas">Nilai Tugas</label>
                <input type="text" class="form-control" name="nilai_tugas" id="nilai_tugas" placeholder="0" onkeyup="nilai();" value="<?php echo $nilai->nilai_tugas ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select name="rombel_id" id="rombel_id" class="custom-select">
                    ...
                    foreach ($rombel as $rowRombel) : ?>
                        <option value="<?= $rowRombel->id_rombel ?>" <?php if ($nilai->rombel_id == $rowRombel->id_rombel) echo "selected" ?>><?= $rowRombel->nama_rombel ?></option>
                    <?php
                    endforeach;
                    ?>
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="nilai_uts" id="nilai_uts" placeholder="0" onkeyup="nilai();" value="<?php echo $nilai->nilai_uts ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select name="mapel_id" id="mapel_id" class="custom-select">
                    ...
                    <?php foreach ($mapel as $rowMapel) : ?>
                        <option value="<?= $rowMapel->id_mapel ?>" <?php if ($nilai->mapel_id == $rowMapel->id_mapel) echo "selected" ?>><?= $rowMapel->nama_mapel ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="nilai_uas" id="nilai_uas" placeholder="0" onkeyup="nilai();" value="<?php echo $nilai->nilai_uas ?>">
        ...
        <div class="form-row">
                ...
                <select name="tahun_akademik_id" id="tahun_akademik_id" class="custom-select">
                    ...
                    <?php foreach ($tahun_akademik as $rowAkademik) : ?>
                        <?php if ($rowAkademik->status == "Aktif") : ?>
                            <option value="<?= $rowAkademik->id ?>" <?php if ($nilai->tahun_akademik_id == $rowAkademik->id) echo "selected" ?>><?= $rowAkademik->tahun_akademik ?> - <?= $rowAkademik->semester ?></option>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="nilai_akhir" id="nilai_akhir" placeholder="0" value="<?php echo $nilai->nilai_akhir ?>">
            </div>
        </div>
